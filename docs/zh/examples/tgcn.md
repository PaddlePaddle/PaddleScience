...
=== "模型训练命令"
    ...
    ``` sh
    wget -nc https://paddle-org.bj.bcebos.com/paddlescience/datasets/tgcn/tgcn_data.zip
    unzip tgcn_data.zip
...
=== "模型评估命令"
    ...
    wget -nc https://paddle-org.bj.bcebos.com/paddlescience/datasets/tgcn/tgcn_data.zip
    unzip tgcn_data.zip
    wget -nc https://paddle-org.bj.bcebos.com/paddlescience/models/tgcn/PEMSD8_pretrained_model.pdparams
    python run.py data_name=PEMSD8 mode=eval EVAL.pretrained_model_path=PEMSD8_pretrained_model.pdparams
    # wget -nc https://paddle-org.bj.bcebos.com/paddlescience/models/tgcn/PEMSD4_pretrained_model.pdparams
