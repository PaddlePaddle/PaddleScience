...
``` py linenums="35" title="examples/chem/Chem.py"
--8<--
examples/chem/Chem.py:35:57
--8<--
```
...
``` py linenums="63" title="examples/chem/Chem.py"
--8<--
examples/chem/Chem.py:63:79
--8<--
```
...
``` py linenums="81" title="examples/chem/Chem.py"
--8<--
examples/chem/Chem.py:81:83
--8<--
```
...
``` py linenums="89" title="examples/chem/Chem.py"
--8<--
examples/chem/Chem.py:89:101
--8<--
```
