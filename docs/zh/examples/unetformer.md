...
``` py linenums="12"
--8<--
examples/unetformer/config/vaihingen/unetformer.py:12:37
--8<--
```
...
``` py linenums="72"
--8<--
examples/unetformer/config/vaihingen/unetformer.py:71:82
--8<--
```
...
``` py linenums="237"
--8<--
examples/unetformer/train_supervision.py:237:302
--8<--
```
