...
=== "模型评估命令"
    ...
    python VP_NSFNet2.py    mode=eval  DATASET_PATH=https://paddle-org.bj.bcebos.com/paddlescience/datasets/NSFNet/cylinder_nektar_wake.mat  EVAL.pretrained_model_path=https://paddle-org.bj.bcebos.com/paddlescience/models/nsfnet/nsfnet4.pdparams
    ```
## 1. 背景简介
