...
According to the dimensionless formula and boundary conditions obtained in [2. Problem Definition](#2), corresponding to two constraints guiding model training in the computational domain, namely:
...
The second parameter is the target value of the constraint variable. Here fill in `equation["NavierStokes"].equations` instantiated in the [3.3 Equation Construction](#33) section;
...
The rest of the configuration is similar to the setting of [Constraint Construction](#35).
