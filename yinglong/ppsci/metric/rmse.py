...
class LatitudeWeightedRMSE(base.Metric):
    ...
    Args:
        num_lat (int): : Number of latitude for compute weight, if is None, no weight applied.
    ...
    def __init__(
        ...
        self.unlog = unlog
        self.scale = scale
        self.weight = self.get_latitude_weight(num_lat) if num_lat is not None else None
