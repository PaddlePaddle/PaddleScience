...
class FNOGNO(nn.Layer):
    ...
    def latent_embedding(self, in_p, f, ada_in=None):
        ...
        in_p = in_p.transpose([self.in_coord_dim, *self.in_coord_dim_forward_order]).unsqueeze(0)
    ...
    def integrate_latent(self, in_p, out_p, latent_embed):
        ...
        latent_embed = latent_embed.transpose([*self.in_coord_dim_reverse_order, 0]).reshape([-1, self.fno.hidden_channels])
