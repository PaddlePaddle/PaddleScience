...
class ERA5ClimateDataset(io.Dataset):
    ...
    def __init__(
        ...
        end_time = time.time()
        print("Data loaded!")
        print(f"Total hours: {self.data_hourly.shape[0]}, Shape: {self.data_hourly.shape}")
    ...
    def __getitem__(self, global_idx):
        ...
        x_weekly_groups = x_hourly.reshape(self.sq_length, self.group_size, *x_hourly.shape[1:])
        y_weekly_groups = y_hourly.reshape(self.sq_length, self.group_size, *y_hourly.shape[1:])
