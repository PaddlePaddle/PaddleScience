...
xtrain, xtest, ytrain, ytest = train_test_split(
    Xlist, data, test_size=0.1, random_state=20
)
x = {
    "key_{}".format(i): paddle.unsqueeze(
        paddle.to_tensor(xtest[:, i], "float32"), axis=1
    )
...
# 重载参数
ppsci.utils.save_load.load_checkpoint(
    r"D:\resources\machine learning\paddle\2024-08\Est\output\checkpoints\latest",
    model,
    optimizer,
)
