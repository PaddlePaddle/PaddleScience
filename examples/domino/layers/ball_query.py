...
if __name__ == "__main__":
    ...
    points1 = paddle.rand([n, p1, d])
    points1.stop_gradient = False

    points2 = paddle.rand([n, p2, d])
    points2.stop_gradient = False
    lengths1 = paddle.full((n,), p1, dtype=paddle.int32)
    lengths2 = paddle.full((n,), p2, dtype=paddle.int32)
    ...
    for i in range(2):
        ...
        p2 += 100
        points1 = paddle.rand([n, p1, d])
        points1.stop_gradient = True
        points2 = paddle.rand([n, p2, d])
        points2.stop_gradient = True
        lengths1 = paddle.full((n,), p1, dtype=paddle.int32)
        lengths2 = paddle.full((n,), p2, dtype=paddle.int32)
    ...
    with wp.ScopedTimer("matrix multiplication 256", active=True):
        outputs2 = paddle.matmul(points1[0], paddle.ones([3, k]))
    ...
    optimizer = paddle.optimizer.SGD(parameters=[points2], learning_rate=0.01)
