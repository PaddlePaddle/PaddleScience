...
# fname = "ldc2d_unsteady_Openfoam_Re100"
# num_xy = 101
...
fname = "ldc2d_unsteady_Openfoam_Re400"
num_xy = 401
...
xx = np.linspace(start=-0.5, stop=0.5, num=num_xy)
yy = np.linspace(start=-0.5, stop=0.5, num=num_xy)
