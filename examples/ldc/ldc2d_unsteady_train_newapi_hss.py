...
inputeq = replicate_t(time_array, inputeq)
...
for i in range(time_num):
    psci.visu.__save_vtk_raw(filename=f"./vtk/ldc2d_output_u_time{i}", cordinate=geo_disc.interior, data=solution[0][i*9801:(i+1)*9801])
# psci.visu.save_vtk(
