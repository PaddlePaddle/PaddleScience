...
if __name__ == "__main__": 
    ...
    geo = psci.geometry.Rectangular(
        time_dependent=True, time_origin=0, time_extent=60, space_origin=(-0.05, -0.05), space_extent=(0.05, 0.05))

    # PDE Laplace
    pdes = psci.pde.NavierStokes(nu=0.01, rho=1.0, dim=2, time_dependent=True)
    
    # Discretization
    pdes, geo = psci.discretize(pdes, geo, time_nsteps=61, space_nsteps=(21, 21))
