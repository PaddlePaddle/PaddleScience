...
# total loss
loss = losseq1 + losseq2 + losseq3 + losseq4 + 10.0 * lossbc1 + lossbc2 + 10.0*lossbc3 + 10.0 * lossic + 10.0 * losssup 
# loss = losseq1 + losseq2 + losseq3 + losseq4 + losseq5 + losseq6 + 10.0 * lossbc1 + lossbc2 + 10.0 * 
# lossic + losssup 
