...
# opt_params = './checkpoint/dynamic_opt_params_11000.pdopt'
...
# psci.visu.__save_vtk_raw(cordinate=cord, data=solution[0][-n::])
psci.visu.save_vtk_cord(filename="./vtk/output_2023_1_31_new_train", time_array=time_array, cord=cord, data=solution)