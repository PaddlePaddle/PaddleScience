...
class LoveDATrainDataset(paddle.io.Dataset):
    def __init__(
        self,
    ...
    def load_img_and_mask(self, index):
        ...
        img_name = os.path.join(
            self.data_root, img_type, self.img_dir, img_id + self.img_suffix
        )
        mask_name = os.path.join(
            self.data_root, img_type, self.mask_dir, img_id + self.mask_suffix
        )
...
loveda_val_dataset = LoveDATrainDataset(
    data_root="data/LoveDA/Val", mosaic_ratio=0.0, transform=val_aug
)


class LoveDATestDataset(paddle.io.Dataset):
    def __init__(
        self,
        data_root="data/LoveDA/Test",
        img_dir="images_png",
        img_suffix=".png",
        mosaic_ratio=0.0,
        img_size=ORIGIN_IMG_SIZE,
