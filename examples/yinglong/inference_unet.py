...
if __name__ == "__main__":
    ...
    OUTPUT_DIR = "../output/hrrr_unet_6226" if not args.output_dir else args.output_dir
    PRETRAINED_MODEL_PATH = "../output/hrrr_unet_6226/checkpoints/latest"
    # initialize logger
