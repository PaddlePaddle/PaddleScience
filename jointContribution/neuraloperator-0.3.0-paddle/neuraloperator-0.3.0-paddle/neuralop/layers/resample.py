...
def resample(x, res_scale, axis, output_shape=None):
    ...
    Args:
        ...
        res_scale (optional[int,tuple]): 
            Scaling factor along each of the dimensions in
    ...
    out_fft = paddle.zeros([x.shape[0], x.shape[1], *new_fft_size], dtype=paddle.complex64)
