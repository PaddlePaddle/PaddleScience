...
class CompositeTransform(SpatialTransform):
    ...
    @overload
    def __init__(self, grid: Grid, transforms: Union[OrderedDict, paddle.nn.LayerDict]) -> None:
    ...
    def __init__(
        self, *args: Optional[Union[Grid, paddle.nn.LayerDict, OrderedDict, SpatialTransform]]
    ) -> None:
        r"""Initialize composite transformation."""
