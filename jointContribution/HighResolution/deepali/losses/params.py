...
class L1Norm(ParamsLoss):
    """Regularization loss term based on L1-norm of model parameters."""
...
class L2Norm(ParamsLoss):
    """Regularization loss term based on L2-norm of model parameters."""
...
class Sparsity(ParamsLoss):
    """Regularization loss term encouraging sparsity of non-zero model parameters."""
