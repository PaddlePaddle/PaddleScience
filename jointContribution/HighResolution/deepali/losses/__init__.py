...
def is_pairwise_image_loss(arg: Any) -> bool:
    """Check if given argument is name or instance of pairwise image loss."""
    return is_loss_of_type(PairwiseImageLoss, arg)


def is_displacement_loss(arg: Any) -> bool:
    """Check if given argument is name or instance of displacement field loss."""
    return is_loss_of_type(DisplacementLoss, arg)


def is_pointset_distance(arg: Any) -> bool:
    """Check if given argument is name or instance of point set distance."""
...
def new_loss(name: str, *args, **kwargs) -> paddle.nn.Layer:
    ...
    if cls is paddle.nn.Layer or not issubclass(cls, paddle.nn.Layer):
