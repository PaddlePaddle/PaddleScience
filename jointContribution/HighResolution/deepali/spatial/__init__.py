...
from .bspline import BSplineTransform  # noqa: F401
...
from .composite import SequentialTransform  # noqa: F401
from .generic import GenericSpatialTransform
from .generic import TransformConfig
from .generic import affine_first
from .generic import has_affine_component
from .generic import has_nonrigid_component
from .generic import nonrigid_components
from .generic import transform_components
...
from .linear import Translation  # noqa: F401
from .nonrigid import DenseVectorFieldTransform
...
from .transformer import PointSetTransformer
...
COMPOSITE_TRANSFORMS = "MultiLevelTransform", "SequentialTransform"
__all__ = (
    (
        "CompositeTransform",
...
def is_spatial_transform(arg: Any) -> bool:
    """Whether given object or named transformation is a transformation type.
...
def is_linear_transform(arg: Any) -> bool:
    """Whether given object is a linear transformation type.
...
def is_nonrigid_transform(arg: Any) -> bool:
    """Whether given object is a non-rigid transformation type.
...
def new_spatial_transform(
    ...
    """Initialize new transformation model of named type.
    ...
    raise ValueError(
        f"new_spatial_transform() 'name={name}' is not a valid transformation type"
    )
