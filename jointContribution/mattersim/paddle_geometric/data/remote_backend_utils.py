...
# characterized as Tuple[FeatureStore, GraphStore]). TODO support for
# non-heterogeneous graphs (feature stores with a group_name=None).

from typing import Optional, Tuple, Union, overload

from paddle_geometric.data import FeatureStore, GraphStore
...
# NOTE PaddleGeometric also supports querying by a relation type `rel` in an edge type
