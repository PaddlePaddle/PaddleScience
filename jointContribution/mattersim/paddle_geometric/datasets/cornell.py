...
from paddle_geometric.data import InMemoryDataset, download_url
...
class CornellTemporalHyperGraphDataset(InMemoryDataset):
    ...
    url = ('https://huggingface.co/datasets/SauravMaheshkar/{}/raw/main/processed/{}/{}')
    ...
    def process(self) -> None:
        for raw_path, path in zip(self.raw_paths, self.processed_paths):
            ...
            for i, row in df.iterrows():
                ...
                x = paddle.to_tensor([[row['timestamp']]], dtype='float32')
