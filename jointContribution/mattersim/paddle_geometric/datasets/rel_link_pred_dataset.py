    ...
    def process(self) -> None:
        ...
        for split in ['train', 'valid', 'test']:
            with open(osp.join(self.raw_dir, f'{split}.txt')) as f:
                ...
                kwargs[f'{split}_edge_index'] = paddle.to_tensor([src, dst])
                kwargs[f'{split}_edge_type'] = paddle.to_tensor(rel)
        ...
        edge_type = paddle.concat([edge_type, edge_type + len(relations_dict)])
