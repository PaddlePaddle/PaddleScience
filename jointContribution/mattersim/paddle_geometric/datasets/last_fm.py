...
class LastFM(InMemoryDataset):
    r"""A subset of the last.fm music website keeping track of users' listening
    ...
    def process(self) -> None:
        ...
        for i, node_type in enumerate(node_types):
            data[node_type].num_nodes = int((node_type_idx == i).sum().item())
        ...
        for name in ['train', 'val', 'test']:
            if name != 'train':
                ...
                edge_index = paddle.to_tensor(edge_index, dtype='int64').t()
