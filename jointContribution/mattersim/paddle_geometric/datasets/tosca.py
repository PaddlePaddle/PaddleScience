...
class TOSCA(InMemoryDataset):
    r"""The TOSCA dataset, from the book `"Numerical Geometry of Non-Rigid Shapes"
    <https://www.amazon.com/Numerical-Geometry-Non-Rigid-Monographs-Computer/
    dp/0387733000>`_, containing 80 meshes. Meshes within the same category
    have the same triangulation and an equal number of vertices, numbered in
    a compatible way.
    ...
    .. note::
        ...
        :obj:`paddle_geometric.transforms.FaceToEdge` as :obj:`pre_transform`.
        To convert the mesh to a point cloud, use the
        :obj:`paddle_geometric.transforms.SamplePoints` as :obj:`transform`
        to sample a fixed number of points on the mesh faces according to their
        face area.

    Args:
        root (str): Root directory where the dataset should be saved.
        categories (list, optional): List of categories to include in the dataset.
            Can include :obj:`"Cat"`, :obj:`"Centaur"`, :obj:`"David"`, :obj:`"Dog"`,
            :obj:`"Gorilla"`, :obj:`"Horse"`, :obj:`"Michael"`, :obj:`"Victoria"`, :obj:`"Wolf"`.
            If set to :obj:`None`, the dataset will contain all categories. (default: :obj:`None`)
        transform (callable, optional): A function/transform that takes in a
            :obj:`paddle_geometric.data.Data` object and returns a transformed version.
        ...
        pre_filter (callable, optional): A function that takes in a
            :obj:`paddle_geometric.data.Data` object and returns a boolean value,
    ...
    def process(self) -> None:
        ...
        for cat in self.categories:
            ...
            for path in paths:
                ...
                face = read_txt_array(f'{path}.tri', dtype='int64')
                face = face - paddle.min(face)  # Ensure zero-based index.
