...
class FB15k_237(InMemoryDataset):
    ...
    .. note::
        ...
        :class:`~paddle_geometric.datasets.FB15k_237` describes a subset of
    ...
    def process(self) -> None:
        ...
        for path in self.raw_paths:
            ...
            edge_index = paddle.zeros([2, len(lines)], dtype='int64')
            edge_type = paddle.zeros([len(lines)], dtype='int64')
