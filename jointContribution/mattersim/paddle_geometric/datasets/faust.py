...
import paddle
from paddle_geometric.data import InMemoryDataset, extract_zip
from paddle_geometric.io import read_ply
    ...
    **STATS:**
    ...
    def process(self) -> None:
        ...
        for i in range(100):
            ...
            data.y = paddle.to_tensor([i % 10], dtype='int64')
        ...
        osp.rmdir(osp.join(self.raw_dir, 'MPI-FAUST'))
