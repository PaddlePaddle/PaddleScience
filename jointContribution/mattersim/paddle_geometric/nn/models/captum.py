...
from paddle_geometric.typing import Metadata
...
def to_captum_model(
    ...
    .. code-block:: python
        ...
        from paddle_geometric.nn import to_captum_model, to_captum_input
    ...
    .. code-block:: python
        ...
        from paddle_geometric.nn import HeteroConv
        from paddle_geometric.nn import (captum_output_to_dicts,
    ...
    Args:
        model (paddle.nn.Layer): The model to be explained.
