...
from paddle_geometric.nn import Linear, MFConv, global_add_pool
from paddle_geometric.typing import Adj


class NeuralFingerprint(nn.Layer):
    ...
    Args:
        ...
        **kwargs (optional): Additional arguments of
            :class:`paddle_geometric.nn.conv.MFConv`.
    """
    def __init__(
        self,
        in_channels: int,
