...
class DeepSetsAggregation(Aggregation):
    ...
    Args:
        local_nn (paddle.nn.Layer, optional): The neural network
            :math:`\phi_{\mathbf{\Theta}}`, *e.g.*, defined by
            :class:`paddle.nn.Sequential` or
            :class:`paddle_geometric.nn.models.MLP`. (default: :obj:`None`)
        global_nn (paddle.nn.Layer, optional): The neural network
    ...
    def __init__(
        self,
        local_nn: Optional[paddle.nn.Layer] = None,
        global_nn: Optional[paddle.nn.Layer] = None,
    ):
        super().__init__()
