...
from paddle_geometric.nn.pool.pool import pool_batch, pool_edge, pool_pos
from paddle_geometric.utils import add_self_loops, scatter
...
def max_pool_x(
    ...
    Args:
        cluster (paddle.Tensor): The cluster vector
    ...
    :rtype: (:class:`paddle.Tensor`, :class:`paddle.Tensor`) if :attr:`size` is
        :obj:`None`, else :class:`paddle.Tensor`
    """
    if size is not None:
...
def max_pool(
    ...
    :class:`paddle_geometric.data.Data` object according to the clustering
    ...
    Args:
        ...
        transform (callable, optional): A function/transform that takes in the
            coarsened and pooled :obj:`paddle_geometric.data.Data` object and
            returns a transformed version. (default: :obj:`None`)

    :rtype: :class:`paddle_geometric.data.Data`
    """
    cluster, perm = consecutive_cluster(cluster)
