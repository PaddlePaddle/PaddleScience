...
class SelectOutput:
    ...
    Args:
        node_index (paddle.Tensor): The indices of the selected nodes.
        num_nodes (int): The number of nodes.
        cluster_index (paddle.Tensor): The indices of the clusters each node in
            :obj:`node_index` is assigned to.
        num_clusters (int): The number of clusters.
        weight (paddle.Tensor, optional): A weight vector, denoting the strength
