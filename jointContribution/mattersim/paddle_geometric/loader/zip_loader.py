...
from paddle_geometric.loader import LinkLoader, NodeLoader
from paddle_geometric.loader.base import DataLoaderIterator
from paddle_geometric.loader.utils import infer_filter_per_worker


class ZipLoader(paddle.io.DataLoader):
