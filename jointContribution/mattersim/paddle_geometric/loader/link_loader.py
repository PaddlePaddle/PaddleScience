...
from paddle_geometric.loader.mixin import AffinityMixin, LogMemoryMixin, MultithreadingMixin
...
from paddle_geometric.typing import InputEdges, OptTensor
...
class LinkLoader(
    ...
    :meth:`~paddle_geometric.sampler.BaseSampler.sample_from_edges` function and
