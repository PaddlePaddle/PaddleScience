...
from paddle_geometric.loader import LinkLoader
from paddle_geometric.sampler.base import NegativeSampling, SubgraphType
...
class DistLinkNeighborLoader(LinkLoader, DistLoader):
    ...
    Args:
        ...
        current_ctx (DistContext): Distributed context information of the
            current process.
        concurrency (int, optional): RPC concurrency for asynchronous processing queue.
            (default: :obj:`1`)
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        channel = paddle.multiprocessing.Queue() if async_sampling else None
