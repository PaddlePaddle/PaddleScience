...
# Adapted from the graphlearn-for-pytorch repository
# (Original License: Apache v2)


def to_asyncio_future(future: paddle.futures.Future) -> asyncio.futures.Future:
    r"""Convert a :class:`paddle.futures.Future` to an :obj:`asyncio` future."""
...
class ConcurrentEventLoop:
    ...
    def add_task(self, coro, callback: Optional[Callable] = None):
        r"""Adds an asynchronous coroutine task to run.
