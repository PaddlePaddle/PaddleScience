...
long_description = "PaddlePaddle AI-driven Scientific Computing SDK Library"
...
setuptools.setup(
    name="paddlescience",
    version=paddlescience.__version__,
    author="PaddlePaddle Scientific Computing Team",
